...
class CampaignTests(unittest.TestCase):
    ...
    def test_fallback_campaign_only_uses_full_attention(self):
        ...
        self.assertEqual(campaign.BASE_ENV["DEVICE_BATCH_SIZE"], "8")
        self.assertEqual(campaign.BASE_ENV["USE_VALUE_EMBEDS"], "0")
        self.assertEqual(campaign.BASE_ENV["MATRIX_LR"], "0.0005")
        self.assertEqual(campaign.BASE_ENV["GRAD_CLIP_NORM"], "0")
        self.assertEqual(campaign.BASE_ENV["MLP_KIND"], "relu_squared")
        self.assertEqual(campaign.BASE_ENV["OPENCLAW_DISABLE_TORCH_COMPILE"], "0")
        self.assertEqual(campaign.BASE_ENV["UNCOUNTED_WARMUP_STEPS"], "11")
        ...
        self.assertEqual(campaign.BASE_ENV["OPENCLAW_CHECKPOINT_IF_BEST"], "0")
        self.assertEqual(campaign.BASE_ENV["OPENCLAW_BEST_VAL_BPB"], "inf")
        self.assertEqual(campaign.BASE_ENV["OPENCLAW_SAMPLE_TOKENS"], "160")
